...
INSERT INTO regiones (id, nombre) VALUES (7, 'Oceaía');
...
INSERT INTO `usuarios` (username, password, enabled,nombre,apellido,email) VALUES ('usuario','$2a$10$XwnMSHeuqYq1XowuHaYj.OiDE0/kFzdkrNx/jXW6Tt9HWziom5Ztq',1,'Andres','Guzman','email@email.com');
INSERT INTO `usuarios` (username, password, enabled,nombre,apellido,email) VALUES ('admin','$2a$10$7P4Yhw55TZEViqjAWtp9/.2KxRuhtnCx5URMWTpeUEQfIkBfzGsOW',1,'David','Sullcaray','eeuuxbox1@gmail.com');
